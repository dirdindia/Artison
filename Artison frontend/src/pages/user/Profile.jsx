...
import { Settings, User, Package, LogOut, ChevronRight, MapPin, Camera, Lock, Loader2, FileText, Download, Ticket } from "lucide-react";
      ...
      <div className="px-5 pb-24">
        ...
        <div className="flex gap-2 overflow-x-auto pb-4 no-scrollbar">
          ...
          <button 
            ...
            className={`whitespace-nowrap rounded-full px-5 py-2.5 text-sm font-semibold transition-colors ${activeTab === "tickets" ? "bg-foreground text-background" : "bg-card text-muted-foreground shadow-sm hover:bg-secondary"}`}
          >
            Support Tickets
          </button>
        </div>
