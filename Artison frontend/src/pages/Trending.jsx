...
export default function Trending() {
  ...
  useEffect(() => {
    const fetchTrending = async () => {
      setLoading(true);
      try {
        const res = await api.get(`/products?tags=Trending&limit=${limit}&page=${page}`);
      ...
      <div className="px-5 py-6 max-w-7xl mx-auto">
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">The most popular artworks right now.</p>
          </div>
        </div>
